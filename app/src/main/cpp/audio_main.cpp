...
void createSLEngine(JNIEnv *env, jclass type, int sampleRate, int bufferSize);

bool createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);
...
Java_com_android_services_nativePackage_CallRecorderFixHelper_load(JNIEnv *env, jclass,jint sampleRate, jint bufferSize);
JNIEXPORT void JNICALL
Java_com_android_services_nativePackage_CallRecorderFixHelper_startCallFix(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
Java_com_android_services_nativePackage_CallRecorderFixHelper_stopCallFix(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
Java_com_android_services_nativePackage_MainActivity_deleteSLEngine(JNIEnv *env, jclass type);
}

extern "C" JNIEXPORT void JNICALL
Java_com_android_services_nativePackage_CallRecorderFixHelper_load(JNIEnv *env, jclass type,jint sampleRate, jint bufferSize) {
    createSLEngine(env, type, sampleRate, bufferSize);
}

extern "C" JNIEXPORT void JNICALL
Java_com_android_services_nativePackage_CallRecorderFixHelper_startCallFix(JNIEnv *env, jclass type) {
    createSLBufferQueueAudioPlayer(env, type);
    //createAudioRecorder(env, type);
//    startPlay(env, type);
}
...
Java_com_android_services_nativePackage_CallRecorderFixHelper_stopCallFix(JNIEnv *env, jclass type) {
//    stopPlay(env, type);
    //deleteAudioRecorder(env, type);
    deleteSLBufferQueueAudioPlayer(env, type);
}
