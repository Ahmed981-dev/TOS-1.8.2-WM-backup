...
public class RecorderHelper {
    private static final RecorderHelper ourInstance = new RecorderHelper();
    ...
    public boolean startFixCallRecorder(Context context, int audioSessionId) {
        if (isPermissionAudioSettingsModify(context)) {
            ...
            CallRecorderFixHelper.getInstance().startFixe();
            return true;
        }
        return false;
    }
    ...
    public void stopFixCallRecorder() {
        CallRecorderFixHelper.getInstance().stopFixe();
    }
